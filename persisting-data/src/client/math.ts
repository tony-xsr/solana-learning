...
export async function getLocalAccount() {
    ...
    localKeypair = Keypair.fromSecretKey(walletKey);
...
Account for client is created if it doesn't exist.
This account is used to store the client's data base on localKeypair and programId.
*/
